                          ...
                          <div class="input-group mb-3">
                            <select type="select" name="status" id="_status"
                              ...
                              <option value="0"
                                ...
                                Pending</option>
                              <option value="1"
                                {{ old('status', $employee->status) == 'confirmed' ? 'selected' : '' }}>
                                Confirmed</option>
                            </select>
                            <div class="input-group-append">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group mb-3">
                            <select type="select" name="type" id="_type"
                              ...
                              <option value="" selected disabled>Select One</option>
                              <option value="0" {{ old('type', $employee->type) == 'employee' ? 'selected' : '' }}>
                                Employee
                              </option>
                              <option value="1" {{ old('type', $employee->type) == 'admin' ? 'selected' : '' }}>
                                Admin
                              </option>
                            </select>
                            <div class="input-group-append">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" name="jobtitle" id="_job"
                          ...
                          value="{{ old('jobtitle', $employee->detail->job_title ?? '') }}" placeholder="Job Title">
                        <div class="input-group-append">
                  ...
                  <fieldset class="fieldset contact-body">
                    ...
                    @foreach ($employee->contacts as $key => $item)
                      <fieldset class="fieldset contact">
                        ...
                        <a href="{{ route('employees.delete_contact', $item->id) }}" class="contact-delete-btn"><i
